...
export default function Services() {
  ...
  return (
    <section className="industry-pattern relative py-24 overflow-hidden bg-[#f6f8fb]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className={`mb-24 ${isAr ? "text-right" : "text-left"}`}>
          ...
          <div className="mb-16">
            ...
            <h2 className="mt-3 text-4xl xl:text-5xl font-black text-slate-900">
              {isAr ? "التعبئة" : "Innovative"}{" "}
              <span className="text-blue-600">
                {isAr ? "المبتكرة" : "Packaging"}
              </span>
            </h2>
            <p className="mt-4 text-slate-500 max-w-2xl text-lg leading-relaxed italic">
              {isAr
                ? "أكياس البولي بروبلين المنسوجة أكثر من مجرد حل للتعبئة — إنها منتج ابتكار وتكنولوجيا، مصممة لتلبية الاحتياجات المتطورة للصناعات الحديثة."
                : "PP woven sacks are more than just a packaging solution — a product of innovation and technology designed to meet the evolving needs of modern industries."}
            </p>
          </div>

          {/* Row: Icon box + text */}
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
            <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm flex items-start gap-6">
              <div className="w-14 h-14 rounded-2xl bg-yellow-400 flex items-center justify-center flex-shrink-0 text-2xl">
                💡
              </div>
              <p className="text-slate-600 leading-relaxed">
                {isAr
                  ? "متانتها ومرونتها وصداقتها للبيئة تجعلها أصلاً قيماً في السوق اليوم. مع التحرك نحو مستقبل أكثر استدامة، تلعب أكياس PP المنسوجة دوراً محورياً في تشكيل مشهد حلول التعبئة."
                  : "Their durability, versatility, and eco-friendliness make them a valuable asset. PP woven sacks are set to play a pivotal role in shaping the landscape of packaging solutions."}
              </p>
            </div>

            <p className="text-slate-600 leading-relaxed text-lg">
              {isAr
                ? "في مجال حلول التعبئة، تتميز أكياس PP المنسوجة بقدرتها على التكيف ومرونتها. تصميمها يخدم تطبيقات متعددة، من تخزين المنتجات الزراعية إلى تعبئة مواد البناء. هيكلها المتين يضمن النقل الآمن للبضائع."
          ...
          <div className="bg-yellow-400 rounded-3xl p-10 mb-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-800 font-bold leading-relaxed text-lg uppercase">
                {isAr
                  ? "تتطلع الإخلاص إلى نمو مستمر ونجاح متواصل. نحن ملتزمون بخدمة عملائنا بنفس التفاني والتميز الذي جعلنا شركاء موثوقين. معاً نتطلع لبناء مستقبل أكثر إشراقاً."
